...
echo [5/5] Firmando y Desplegando en !DEVICE_ID!...
...
adb -s %DEVICE_ID% install -r Electric_Final.apk
adb -s %DEVICE_ID% shell am start -n com.antigravity.electric/com.antigravity.electric.BackHandler
...
echo.
echo ==================================================
echo  INSTALADO EN DISPOSITIVO: %DEVICE_ID%
echo ==================================================
pause
